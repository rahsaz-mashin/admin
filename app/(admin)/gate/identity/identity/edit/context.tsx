...
import {z} from "zod";
import {FormRender, FormRenderFunc} from "@/stories/FormHandler";
...
import {NeshanAddress} from "@/types/NeshanAddress";


export type T = Identity
    ...
    return [
        {
            ...
            onSectionChange: (section: string) => {
                setValue("identityType", section === "legal" ? identityTypesEnum.legal : identityTypesEnum.real)
            ...
            fields: (index) => [
                ...
                },
                {
                    ...
                    dependency: async () => {
                        ...
                        const location = watch(`addresses.${index}.location`)
                        if (!location) return
                        // location = typeof location === "string" ? location?.split(",") : Object.values(location)

                        const params = {location}

                        const data: NeshanAddress = await axios.get("neshan/getAddress", {params})
