...
import {z} from "zod";
import {FormRender} from "@/stories/FormHandler";
import {FormFieldFunc} from "@/stories/General/FormFieldsGenerator";
import {Button, Card, CardHeader, CardBody, Snippet} from "@heroui/react";
import moment from "jalali-moment";
import {Account} from "@/interfaces/Account.interface";
import {BoldDuotonePermissionGroupIcon} from "@/stories/AdminIcons";
...
const formFields: FormFieldFunc<T> = (watch, setValue) => {
    ...
    return ([
        ...
        },
        {
            ...
            className: "col-span-full",
            children: function () {
                const token: string | undefined = watch("token");
