...
import {
    ...
    MimetypeOtherIcon, MimetypePdfIcon, MimetypePresentationIcon,
    MimetypeVideoIcon, MimetypeWordIcon, MimetypeZipIcon,
...
export type MinorUploaderProps<T extends FieldValues> = {
    name: Path<T>;
    control: Control<T>;
...
export const MinorUploader = <T extends FieldValues, >(props: MinorUploaderProps<T>) => {
    const {
        name,
        control,
