...
import {Radio, RadioGroup, Spinner, Tooltip, Button, Pagination} from "@heroui/react";
...
export type MinorIconLibraryProps<T extends FieldValues> = {
    name: Path<T> ;
    control: Control<T>;
...
export const MinorIconLibrary = <T extends FieldValues,>(props: MinorIconLibraryProps<T>) => {
    const {
        name,
        control,
