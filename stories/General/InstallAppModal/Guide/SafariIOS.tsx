...
export default function SafariIOS(props: Props) {
    ...
    return (
        ...
        >
            <KeyboardDoubleArrowDown fontSize="large"
                                     className="absolute bottom-[10px] z-[103] mx-[calc(50%-17.5px)] animate-bounce text-primary"/>
            <ModalContent>
                ...
                <ModalBody>
                    ...
                    <div className="flex flex-col gap-1 text-sm text-gray-500">
                        <div className="flex flex-wrap items-center gap-1">
                            <p>بر روی</p>
                            <TbShare2 className="text-2xl text-primary"/>
                            <p>کلیک کنید</p>
                        </div>
                        <div className="flex flex-wrap items-center gap-1">
