...
export const CallWidget = () => {
  ...
  return (
    <>
      <div dir="rtl" className="flex relative items-center justify-center">
        <Card isHoverable shadow="lg" className="mr-8 w-full">
          <AnimatePresence>
            {status === "default" && (
              <MotionCardBody
                initial={{ scaleY: 0 }}
                ...
                className="text-center relative overflow-hidden p-0 pr-8 h-32 cursor-pointer items-center flex flex-row select-none"
              >
                <div className="flex flex-col w-full flex-1 px-1.5">
                  <a
                ...
                <div className="flex flex-col p-5 justify-between">
                  <a href="t.me/">
                    <svg
                      className="w-6 h-6 transition text-black hover:text-telegram hover:scale-110 active:scale-90"
                      viewBox="0 0 18 18"
                      fill="currentColor"
                  ...
                  <a href="instagram.com/">
                    <svg
                      className="w-6 h-6 transition text-black hover:text-instagram hover:scale-110 active:scale-90"
                      viewBox="0 0 18 18"
                      fill="currentColor"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M12 5.25003C12 4.83582 12.3358 4.50003 12.75 4.50003C13.1642 4.50003 13.5 4.83582 13.5 5.25003C13.5 5.66425 13.1642 6.00003 12.75 6.00003C12.3358 6.00003 12 5.66425 12 5.25003Z" />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
          ...
          {(status === "menu" || status === "calling") && (
            <MotionCardBody
              ...
              className="text-center relative overflow-hidden p-0 pr-8 h-32 cursor-pointer items-center flex flex-row select-none"
            >
              <div className="flex flex-col w-full gap-3 flex-1 px-1.5">
                {status === "menu" && (
                  <motion.b
                    initial={{ scaleY: 0 }}
                    animate={{ scaleY: 1 }}
              ...
              <AnimatePresence>
                {status === "calling" && (
                  <motion.div
                    ...
                    className="bg-red-600 text-white hover:shadow hover:bg-red-200 hover:text-red-600 w-32 transition duration-700 h-full flex justify-center items-center overflow-hidden whitespace-nowrap"
                    initial={{ width: 0 }}
                    animate={{ width: 128 }}
                    exit={{ width: 0 }}
        ...
        {status === "default" && (
          <motion.div
            ...
            className="bg-white cursor-pointer start-0 absolute w-16 h-16 p-1 border-4 flex items-center justify-center border-primary rounded-full text-primary"
          >
            <motion.svg
        ...
        {status === "menu" && (
          <motion.div
            ...
            className="bg-white cursor-pointer start-0 absolute w-16 h-16 p-1 border-4 flex items-center justify-center border-danger rounded-full text-danger"
          >
            <motion.svg
              viewBox="0 0 30 30"
              fill="currentColor"
        ...
        {status === "calling" && (
          <motion.div
            ...
            className="bg-white cursor-pointer start-0 absolute w-16 h-16 p-1 border-4 flex items-center justify-center border-success rounded-full text-success shadow-success-100"
          >
            <motion.svg
              viewBox="0 0 30 30"
              fill="currentColor"
