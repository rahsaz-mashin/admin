...
import {
    ...
    BoldDuotoneFeaturesIcon, BoldDuotoneFooterIcon, BoldDuotoneHeaderIcon,
    BoldDuotoneIdentityDocumentIcon,
    BoldDuotoneIntroductionMethodIcon,
    BoldDuotoneListIcon,
    BoldDuotoneLockPasswordIcon,
    BoldDuotoneMapIcon, BoldDuotoneMenuIcon,
    BoldDuotoneMessageBoxIcon, BoldDuotoneOnlineCallIcon,
    ...
    BoldDuotoneSettingIcon, BoldDuotoneShortcutIcon, BoldDuotoneSliderIcon,
    BoldDuotoneStatisticIcon, BoldDuotoneStoryIcon,
                    ...
                    },
                    {
                        ...
                        sub: [
                            ...
                            },
                            {
                                ...
                                description: "مشاهده لیست تخصیص دسته های قیمتی، ایجاد و مدیریت آن ها",
                                isEnable: true,
                            },
                            {
                                key: "price_list_assign",
                                title: "تخصیص دسته های قیمتی",
                                icon: <BoldDuotonePriceIcon size={64}/>,
                                description: "مشاهده لیست قوانین دسته های قیمتی، ایجاد و مدیریت آن ها",
                                isEnable: true,
                            },
                        ],
                    },
                        ...
                        sub: [
                            {
                                key: "story",
                                title: "استوری",
                                icon: <BoldDuotoneStoryIcon size={64}/>,
                                description: "مشاهده لیست استوری ها، ایجاد و مدیریت آن ها",
                                isEnable: true,
                            },
                            {
                                key: "slider",
                                title: "اسلایدر",
                                icon: <BoldDuotoneSliderIcon size={64}/>,
                                description: "مشاهده لیست اسلایدرها، ایجاد و مدیریت آن ها",
                                isEnable: true,
                            },
                            {
                                key: "online_call",
                                title: "تماس آنلاین",
                                icon: <BoldDuotoneOnlineCallIcon size={64}/>,
                                description: "تنظیمات مربوط به ویجت تماس آنلاین",
                                isEnable: true,
                            },
                            {
                                key: "shortcuts",
                            ...
                            },
                            {
                                key: "header",
                                title: "لینک های هدر",
                                icon: <BoldDuotoneHeaderIcon size={64}/>,
                                description: "مدیریت لینک های هدر و تنظیمات آن",
                                isEnable: true,
                            },
                            {
                                key: "footer",
                                title: "لینک های فوتر",
                                icon: <BoldDuotoneFooterIcon size={64}/>,
                                description: "مدیریت لینک های فوتر و تنظیمات آن",
                                isEnable: true,
                            },
                            {
                                key: "menu",
                                title: "منو",
                                icon: <BoldDuotoneMenuIcon size={64}/>,
                                description: "مشاهده لیست آیتم های منو، ایجاد و مدیریت آن ها",
                                isEnable: true,
                            },
                        ],
                    },
